...
namespace MiniRestSharpCore
{
    ...
    public partial class RestClient : IRestClient
    {
        ...
        /// <summary>
        /// Content types that can generally be handled by a JSON serializer/deserializer.
        /// </summary>
        public static string[] DefaultJsonContentTypes
        {
            get
            {
                return new string[]
        ...
        /// <summary>
        /// Content types that can generally be handled by an XML serializer/deserializer.
        /// </summary>
        public static string[] DefaultXmlContentTypes
        {
            get
            {
                return new string[]
